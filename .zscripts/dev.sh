...
log_step_start "npm run db:setup"
echo "[NPM] Applying PostgreSQL migrations and bootstrapping data..."
npm run db:setup
log_step_end "npm run db:setup"

log_step_start "npm run dev"
echo "[NPM] Starting development server..."
npm run dev &
DEV_PID=$!
log_step_end "npm run dev"
