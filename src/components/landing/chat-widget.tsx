...
const CANNED_RESPONSES: Record<string, string> = {
  امکانات:
    "روال امکانات متنوعی داره: فلش‌کارت هوشمند، برنامه‌ریزی خودکار، ردیابی پیشرفت، تست‌های تمرینی و خیلی بیشتر! 🎯",
  "قیمت‌ها":
  ...
  "شروع کار":
    "شروع کار با روال خیلی سادست! فقط ثبت‌نام کن، برنامه درسی‌ات رو انتخاب کن و به محض شروع می‌تونی از امکانات استفاده بکنی. 🚀",
};

const DEFAULT_RESPONSE =
  "مرسی از سوالت! 💚 تیم پشتیبانی ما به زودی جواب دقیق می‌دن. در همین حال می‌تونی از بخش سوالات متداول هم استفاده بکنی.";

const QUICK_REPLIES = ["امکانات", "قیمت‌ها", "شروع کار"] as const;
